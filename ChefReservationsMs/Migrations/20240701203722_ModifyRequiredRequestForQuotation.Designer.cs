...
namespace ChefReservationsMs.Migrations
{
    ...
    [Migration("20240701203722_ModifyRequiredRequestForQuotation")]
    partial class ModifyRequiredRequestForQuotation
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ChefReservationsMs.Features.Chefs.Entities.ChefEntity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2024, 7, 1, 20, 37, 19, 27, DateTimeKind.Utc).AddTicks(4785),
                            CreatedBy = "jbasalo",
            ...
            modelBuilder.Entity("ChefReservationsMs.Features.Chefs.Entities.CuisineCatalogEntity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2024, 7, 1, 20, 37, 19, 27, DateTimeKind.Utc).AddTicks(6861),
                            CreatedBy = "jbasalo",
                            CuisineName = "Pasta"
                        });
                });
            ...
            modelBuilder.Entity("ChefReservationsMs.Features.Chefs.Entities.FoodEntity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2024, 7, 1, 20, 37, 19, 27, DateTimeKind.Utc).AddTicks(9918),
                            CreatedBy = "jbasalo",
