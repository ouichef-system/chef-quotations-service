...
namespace ChefReservationsMs.Migrations
{
    ...
    [Migration("20240225034421_ModifyFoodEntity")]
    partial class ModifyFoodEntity
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ChefReservationsMs.Features.Chefs.Entities.ChefEntity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2024, 2, 25, 3, 44, 18, 190, DateTimeKind.Utc).AddTicks(5460),
                            CreatedBy = "jbasalo",
            ...
            modelBuilder.Entity("ChefReservationsMs.Features.Chefs.Entities.CuisineCatalogEntity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2024, 2, 25, 3, 44, 18, 190, DateTimeKind.Utc).AddTicks(8497),
                            CreatedBy = "jbasalo",
                            CuisineName = "Pasta"
                        });
                });
            ...
            modelBuilder.Entity("ChefReservationsMs.Features.Chefs.Entities.FoodEntity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2024, 2, 25, 3, 44, 18, 191, DateTimeKind.Utc).AddTicks(1951),
                            CreatedBy = "jbasalo",
                            CuisineTypeId = new Guid("4827d138-5ff1-4714-95a1-414d950aa817"),
                            MealTypes = new byte[] { 3, 2 },
